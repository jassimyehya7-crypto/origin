...
export const useAppStore = create<AppState>()(
  persist(
    ...
    {
      // Stockage propre à l'interface client : ne pas réutiliser l'état de
      // l'ancienne application combinée (offres masquées, rayon, etc.).
      name: "offreslocal-interface-client-v1",
      version: 3,
